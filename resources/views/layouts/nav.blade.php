    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('threads.index', [ 'popular' => true ]) }}">Popular Threads</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="{{ route('threads.index', [ 'unanswered' => true ]) }}">Unanswered Threads</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        @foreach($channels as $channel)
                            <a class="dropdown-item" href="{{ $channel->path() }}">
                                {{ $channel->name }}
                            </a>
                        @endforeach
                    </div>
